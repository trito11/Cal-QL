...
class TD3_BC:
    ...
    def train(self, batch: TensorBatch, t) -> Dict[str, float]:
        ...
        if self.total_it % self.policy_freq == 0:
            ...
            self.actor_optimizer.second_step()
...
def train(config: TrainConfig):
    ...
    actor_optimizer =   SAM(actor.parameters(), base_optimizer, rho = config.rho, adaptive = True, lr  = config.lr)
    scheduler = StepLR(actor_optimizer, config.lr, config.max_timesteps)
